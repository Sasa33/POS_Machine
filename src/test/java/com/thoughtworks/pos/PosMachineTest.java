...
public class PosMachineTest {
    ...
    public void should_calculate_total_when_given_1_item() {
        ...
        when(promotionManager.getAvailableDiscountPromotion("ITEM000003")).thenReturn(null);
    ...
    public void should_calculate_total_will_apply_discount() {
        List<CartItem> itemCart = Arrays.asList(new CartItem("ITEM000001", 3), new CartItem("ITEM000003", 2));
        when(promotionManager.getAvailableDiscountPromotion("ITEM000003")).thenReturn(new DiscountPromotion(75));
        when(promotionManager.getAvailableDiscountPromotion("ITEM000001")).thenReturn(new DiscountPromotion(75));
