...
public class DiscountPromotionTest {
    ...
    public void should_return_0_when_quantity_0() {
        ...
        double subtotal = discountPromotion.calculate(new CartItem("ITEM000001", 0), 40);
    ...
    public void should_return_0_when_price_0() {
        discountPromotion = new DiscountPromotion(75);
        double subtotal = discountPromotion.calculate(new CartItem("ITEM000001", 5), 0);
    ...
    public void should_return_subtotal_after_discount() {
        discountPromotion = new DiscountPromotion(75);
        double subtotal = discountPromotion.calculate(new CartItem("ITEM000001", 1), 40);
